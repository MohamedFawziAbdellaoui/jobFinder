...
class _ResumeScreenState extends State<ResumeScreen> {
  ...
  ResumeController _resumeController = ResumeController();
  @override
  void initState() {
                              ...
                              return Container(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Align(
                                      alignment: Alignment.center,
                                      child: Text(educationItem.schoolName!),
                                    ),
                                    cv.education!.indexOf(educationItem) !=
                              ...
                              return Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    cv.workExperience!.indexOf(workItem) !=
                                            (cv.workExperience!.length - 1)
                                        ? const Divider(
                                            color: Colors.white,
                                            thickness: 1.5,
                                          )
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Text(DateFormat('dd/MM/yy').format(
                                              DateTime.parse(certif.date!)))
                                        ],
                                      ),
                                      cv.certifications!.indexOf(certif) !=
